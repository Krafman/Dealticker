...
$formproc->AddRecipient('doorgal65@gmail.com'); //<<---Put your email address here
...
// <![CDATA[
    ...
    frmvalidator.addValidation("phone","req","Please provide your phone number so we can call you back");
